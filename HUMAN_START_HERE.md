...
```text
You are to incorporate this CERES for Coding Agents, located at https://github.com/holaymolay/governance-orchestrator, as the governance framework for this project.
