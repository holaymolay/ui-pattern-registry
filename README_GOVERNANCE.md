...
- `README.md` is generated from the spec by `cef-readme-spec-engine`.
...
2. Run `cef-readme-spec-engine` outside this repo to generate `README.md`.
3. Commit both files together.
4. Run README enforcement checks (lint + governance CI) to validate structure and compliance.

## Roles and boundaries
- Generation: `cef-readme-spec-engine` (external project) turns specs into README content.
